...
constexpr float map_range(const float input, const float input_start, const float input_end, const float output_start,
...
void Array::window_resize(const float old_width, const float old_height, const float new_width,
                          const float new_height) const {
